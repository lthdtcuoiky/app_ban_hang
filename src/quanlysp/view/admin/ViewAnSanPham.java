 ...
 * @author huy
 */
public class ViewAnSanPham extends javax.swing.JFrame {

    /**
     * Creates new form frmAnSanPham
     */
    public ViewAnSanPham() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAnSanPham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAnSanPham().setVisible(true);
            }
        });
    }
